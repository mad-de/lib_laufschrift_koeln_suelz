...
def return_command_array():
    ...
    'Aktuelle Temperatur: ' + str(json_weather[u'main'][u'temp']).replace('-', 'Minus ') + '°C. Gefühlte Temperatur ' + str(json_weather[u'main'][u'feels_like']).replace('-', 'Minus ') + '°C. Es ist ' +  str(json_weather[u'weather'][0][u'description'].encode('utf-8')) + '.'
